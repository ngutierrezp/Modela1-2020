...
float pEnfermos = 0.4;                     // Probabilidad de enfermos
float pMaskOn = 0.6;                       // Probabilidad de mascarillas
float pTransmission = 0.9;                 // Probabilidad de transmisición
...
float socialDistancing = 1.0*minDistance;  // Distancia maxima de contagio
